            ...
            <form id="user" action="authenticate.html" method="post" onsubmit = "return validate()">
                ...
                <div class="form-group col-lg-12 col-xs-4 ">
                    <center>
                        ...
                        border-radius : 8px; font-size: 16px; "placeholder="Enter Email - Id" type="email" 
                ...
                <div class="form-group col-lg-12 col-xs-4"><center>
                    <input id="password" name="password" style = "height:50px; width : 450px; padding :12px 20px; 
                        border-radius : 8px; font-size: 16px; " placeholder="Enter Password"
                            type="password" required value="" autocomplete="off"/>
                </div>
                <br><br><br><br>
                <button type="submit" style="border-radius : 8px; margin-left: 458px; height:50px; width : 450px  font-size: 16px; " class="btn btn-success col-lg-4">
                    LET ME IN 
                </button>
