     ...
     <div style="margin-top: 19px;" class="body" style="margin-top: 0px; border-top-width: 0px; border-top-style: solid;" >
          ...
          <form id="user" action="saveUser.html" method="post" onsubmit = "return validate()">
            ...
            <div class="form-group col-lg-12 col-xs-4 ">
              <center>
              <input id="name" name="name" style="padding-right: 95px; padding-left: 106px; margin-left: 12px;" placeholder="Enter Your Name" type="text" value="" autocomplete="off"/></h4>
              </center>
            </div><br><br><br><br>
            <div class="form-group col-lg-12 col-xs-4 ">
              <center>
              <input id="email" name="email" style="padding-right: 95px; padding-left: 106px; margin-left: 12px;" placeholder="Enter Your Email" type="email" value="" autocomplete="off"/></h4>
              </center>
            </div><br><br><br><br>
            <div class="form-group col-lg-12 col-xs-4 ">
              <center>
              <input id="mobileNumber" name="mobileNumber" style="padding-right: 95px; padding-left: 106px; margin-left: 12px;" placeholder="Enter Your Mobile Number" type="int" value="0" autocomplete="off"/></h4>
              </center>
            </div><br><br><br><br>
