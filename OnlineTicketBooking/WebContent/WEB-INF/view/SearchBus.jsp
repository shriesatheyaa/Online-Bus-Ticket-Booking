...
<html lang="en">
    ...
    <body id="page-top" class="bodyColor">
        ...
        <div style="position:fixed; left:80px; top:200px;margin-bottom: 2cm;"  >
            ...
            <form  id="searchBus" name="searchBus" onsubmit="return formValidation()" action="Search.html" 
                   method="post">
                ...
                <p style="position:absolute;left:2Px;top:250px;margin-bottom: 2cm;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pick a Date
                </p>
                <input name="date" id="date"  onchange="dateofTavel()" style="position:absolute;
                        left:2Px;color:black" type="text"  />
                <button style="position:absolute;left:2Px;top:380px;" 
