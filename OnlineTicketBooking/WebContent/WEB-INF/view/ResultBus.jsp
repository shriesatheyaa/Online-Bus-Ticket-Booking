                ...
                <table style="border-top-width: 7px; border-top-style: solid;">
                    ...
                    <c:forEach items="${tripRoutes}" var="tripRoutes">
                        <form:form id = "tripRoute" action="ConfirmBooking.html" method="post" >
                            ...
                            <tr style="border-top-style: solid; border-top-width: 26px;">
                                <td width="20%">
                                    <i class="fa fa-bus" style="font-size:24px;color:black">
                                    </i>
                                    <span style="padding-left:20px">
                                        <b>
                                            <c:out value="${tripRoutes.trip.bus.travels.name}"/>
                                        </b>
                                    </span><br>
                                    <span style="padding-left:40px">
                                        <c:out value="${tripRoutes.trip.bus.type}"/>
                                    </span><br>
                                ...
                                <td id="">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <c:out value="${tripRoutes.departureTime}"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <c:out value="${tripRoutes.arrivalTime}"/>
                                </td>
                                <td>
                                    <i class="material-icons" style="font-size:24px:color:black"></i>
                                    <img height="30" width="20"  src="img/seat.png"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <c:out value="${tripRoutes.trip.seatVacancy}"/>
                                </td>
                                <td>
                                    <i class="fa fa-inr" style="font-size:26px;color:black"></i>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <c:out value="${tripRoutes.price}"/>
                                </td> 
                                <td>
                                    <button class="button button2">Book</button>
                                </td>
                            </tr>
                        </form:form>
                    </c:forEach>
